...
export const pricing = [
  ...
  },
  {
    ...
    cta: 'Book Demo',
    items: [
      [true, '5 WhatsApp numbers'],
      [true, 'Shared inbox (team)'],
      [true, 'Campaign tools'],
      [true, 'Smart chatbot'],
      [true, 'AI agent workflows'],
      [true, 'Automation'],
      [true, 'Analytics'],
      [true, 'Lead import'],
      [true, 'Integrations'],
  ...
  },
  {
    ...
    cta: 'Talk to Sales',
    items: [
      [true, 'Unlimited WhatsApp numbers'],
      [true, 'Shared inbox (advanced)'],
      [true, 'Campaign tools'],
      [true, 'Smart chatbot'],
      [true, 'AI agent workflows'],
      [true, 'Automation'],
